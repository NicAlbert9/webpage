...
img_contact_form= Image.open('pages/images/maxresdefault.jpg')
silop_cave= Image.open('pages/images/silop_cave.jpg')
mabua_beach= Image.open('pages/images/mabua_beach.jpg')
floatingvil= Image.open('pages/images/Floatingvil.jpg')
sagisiisland= Image.open('pages/images/sagisi.jfif')
Buenavista= Image.open('pages/images/buenavistacave.jpg')
lakemainit= Image.open('pages/images/Lake-Mainit.jpg')
alingkakajaw= Image.open('pages/images/alingkakajaw.jpg')
battleofsurigao= Image.open('pages/images/battle_of_surigao.jpg')
balingangafalls= Image.open('pages/images/balinganga.jpeg')
songkoycoldspring= Image.open('pages/images/songkoy-cold-spring.jpg')
